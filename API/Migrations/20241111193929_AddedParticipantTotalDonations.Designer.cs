...
namespace API.Migrations
{
    ...
    [Migration("20241111193929_AddedParticipantTotalDonations")]
    partial class AddedParticipantTotalDonations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.RaffleEntry", b =>
                {
                    ...
                    b.Property<string>("RaffleEventId")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Entities.RaffleEvent", b =>
                {
                    ...
                    b.Property<DateTime?>("PrizeDrawDate")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Entities.RaffleEntry", b =>
                {
                    b.HasOne("API.Entities.EventParticipant", "Participant")
                        .WithMany()
                        .HasForeignKey("ParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.RaffleEvent", "RaffleEvent")
                        .WithMany("Entries")
                        .HasForeignKey("RaffleEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Participant");

                    b.Navigation("RaffleEvent");
                });
            ...
            modelBuilder.Entity("API.Entities.RafflePrize", b =>
                {
                    ...
                    b.HasOne("API.Entities.EventParticipant", "Winner")
                        .WithMany()
